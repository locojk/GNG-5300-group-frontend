...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
      <ClickOutside onClick={() => setSidebarOpen(false)}>
        <aside
            className={`fixed left-0 top-0 z-9999 flex h-screen w-62.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
            ...
            {/*Back-office management name*/}
            <h1 className="font-bold text-white w-full content-center text-center text-xl">
              PersonaFit
            </h1>
          </div>
          {/* <!-- SIDEBAR HEADER --> */}
